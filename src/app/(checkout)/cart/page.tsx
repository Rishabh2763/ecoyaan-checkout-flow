...
export default async function CartPage() {
  ...
  return (
    <main className="min-h-screen bg-white p-4 md:p-10 text-gray-900 font-sans">
      ...
      {/* Increased max-width to 6xl for a wider, more spacious layout */}
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          <a href="#" className="inline-flex items-center gap-2 text-sm text-gray-700 hover:text-[#00875A] transition-colors border-b border-gray-300 pb-0.5">
            <svg className="w-5 h-5 text-[#00875A]" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Items List Header (Light blue background) */}
        <div className="bg-[#f0f6f8] px-6 py-4 rounded-md flex justify-between items-center mb-6">
          ...
          <label className="flex items-center gap-2 cursor-pointer text-sm font-medium text-gray-700">
            {/* The accent color makes the checkbox green when ticked */}
            <input type="checkbox" className="w-4 h-4 accent-[#00875A] rounded" defaultChecked />
            Deselect All Products
          </label>
        </div>
        
        {/* Items List (Removed borders, relying on bottom borders inside CartItem) */}
